...
### Andy to work on this next
##EA1 and EA2 share a number of common columns
...
GV44$Taluka <- droplevels(panchayatsOverlay$Taluka)
GV44$TRU <- droplevels(panchayatsOverlay$TRU)
